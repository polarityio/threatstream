module.exports = {
   ...
   */
  description:
    'Anomali ThreatStream is a Threat Intelligence Platform allowing organizations to access all intelligence feeds and integrate them seamlessly with internal security and IT systems.',
  ...
  options: [
    ...
    },
    {
      ...
      name: 'Username',
      description:
        'The username of the ThreatStream user you want the integration to authenticate as',
      default: '',
      type: 'text',
      userCanEdit: true,
      adminOnly: false
    },
    {
      ...
      name: 'API Key',
      description:
        'The API Key for the provided username you want the integration to authenticate as',
      default: '',
      type: 'password',
      userCanEdit: true,
      adminOnly: false
